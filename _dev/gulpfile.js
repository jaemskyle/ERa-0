//'use strict';
// generated on 2015-02-03 using generator-cg-gas 3.3.3
...
gulp.task('build:dist', ['clean'], function(cb) {
  runSequence(['jshint', 'build', 'copy', 'copy:assets', 'copy:fonts', 'images', 'test:unit'], 'html', cb);
});
...
gulp.task('html', function() {
  ...
  .pipe($.replace('<!-- cordova-script -->','<script src="cordova.js"></script>'))
  .pipe(assets)
